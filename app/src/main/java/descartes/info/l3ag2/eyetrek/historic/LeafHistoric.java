 ...
 * télécharger et afficher l'historique des feuilles analysées
 */
public class LeafHistoric extends Fragment {

    String Url ="http://www.ens.math-info.univ-paris5.fr/~ij00084/leafH.php?id_user=";
    ...
    /**
     * class qui execute le lien donnée en paramétere pour récupérer la liste des feuilles analysées
     */
    class Webservice extends AsyncTask<String , Void ,String> {
        ...
        /**
         * execute le lien en arriere plan
         * @param strings
         * @return
         */
        @Override
        ...
        protected void  onPostExecute (String  JSON_Reponse ) {
            ...
            try {
                ...
                for (int x=0 ;x<jArr.length();x++ ) {
                    ...
                    String p=jObj.getString("leaf") ;
                    String k=jObj.getString("percentage") ;

                    HashMap<String,String> map =new HashMap<>();
                    map.put("leaf",p);
                    map.put("percentage",k);
            ...
            ListAdapter adapter1 = new SimpleAdapter(
                    ...
                    R.layout.item, new String[] { "leaf", "percentage"},
                    new int[] { R.id.item0, R.id.item2});
