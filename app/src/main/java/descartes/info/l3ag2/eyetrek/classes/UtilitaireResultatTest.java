...
public class UtilitaireResultatTest extends TestCase {
    ...
    public void testReadFile(){
        ...
        ArrayList<String> res = new ArrayList<String>(UtilitaireResultat.readFile("raw/liste_leaf1.csv"));
        asserNotNull(res);

        ArrayList<String> res = new ArrayList<String>(UtilitaireResultat.readFile("raw/liste_leaf_details.csv"));
        asserNotNull(res);
