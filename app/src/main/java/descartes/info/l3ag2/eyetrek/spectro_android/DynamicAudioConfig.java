...
public class DynamicAudioConfig {
    ...
    public static final int BITS_PER_SAMPLE = 32; // 16 à la base
    ...
    public DynamicAudioConfig(Context context) {
        ...
        SAMPLE_RATE = Integer.parseInt(prefs.getString(PREF_SAMPLE_RATE_KEY, "32000")); // 16000 à la base
        //SAMPLES_PER_WINDOW = Integer.parseInt(prefs.getString(PREF_SAMPLES_WINDOW_KEY, "300")); // 300 à la base
        SAMPLES_PER_WINDOW = 600;// 300 à la base
        ...
        float newContrast = prefs.getFloat(PREF_CONTRAST_KEY, Float.parseFloat("0.9"));
