package descartes.info.l3ag2.eyetrek.spectro_android.audioproc;
...
import descartes.info.l3ag2.eyetrek.spectro_android.audioproc.filters.BandpassButterworth;
import descartes.info.l3ag2.eyetrek.spectro_android.DynamicAudioConfig;
import descartes.info.l3ag2.eyetrek.spectro_android.HeatMap;
...
public class BitmapProvider {
    ...
    public BitmapProvider(){
        Log.e("BitmapProvider", "BitmapProvider construit sans DynamicAudioConfig ! ");
    }
    ...
    public void start() {
        ...
        if(audioCollector == null) Log.e("BitmapProvider", "audioCollector est null !");
        if(bitmapCreator == null) Log.e("BitmapProvider", "bitmapCreator est null !");
