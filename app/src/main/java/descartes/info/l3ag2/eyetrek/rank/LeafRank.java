...
public class LeafRank extends Fragment {

    String Url ="http://www.ens.math-info.univ-paris5.fr/~ij00084/rankleaf.php";
    private static final String PREFS = "app_prefs";
    SharedPreferences sharedPreferences;
    Button bird,mushroom;
...
//        mushroom = (Button) view.findViewById(R.id.rank_mushroom);
//        lv= (ListView) view.findViewById(R.id.rank_list);

        sharedPreferences = getActivity().getSharedPreferences(PREFS, Context.MODE_PRIVATE);
        String id = sharedPreferences.getString("id", null);

        new LeafRank.Webservice().execute(Url+id);
        return null;
        ...
        protected void  onPostExecute (String  JSON_Reponse ) {
            ...
            try {
                ...
                for (int x=1 ;x<=jArr.length();x++ ) {
                    ...
                    String score=jObj.getString("scoreleaf");
            ...
            ListAdapter adapter1 = new SimpleAdapter(getContext(), listPoint, R.layout.item, new String[] { "leaf"}, new int[] { R.id.item0});
            ...
            mushroom.setOnClickListener((v) -> {
                getFragmentManager().beginTransaction().add(R.id.contenu_fragment, new MushroomRank()).commit();
            });
