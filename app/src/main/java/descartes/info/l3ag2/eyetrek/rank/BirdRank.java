...
public class BirdRank extends Fragment {

    String Url ="http://www.ens.math-info.univ-paris5.fr/~ij00084/rankbird.php";
...
//        leaf = (Button) view.findViewById(R.id.rank_bird);
...
//        lv= (ListView) view.findViewById(R.id.rank_list);
        ...
        new BirdRank.Webservice().execute(Url+id);
        return null;
        ...
        protected void  onPostExecute (String  JSON_Reponse ) {
            ...
            try {
                ...
                for (int x=0 ;x<jArr.length();x++ ) {
                    ...
                    String score=jObj.getString("scorebird");
