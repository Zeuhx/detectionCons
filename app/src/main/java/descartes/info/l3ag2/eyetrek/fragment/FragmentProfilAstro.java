...
public class FragmentProfilAstro extends Fragment implements IOnBackPressed {

    public static final String TAG = "FragmentProfilAstro";

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_profile_astro,container,false);
